...
class _GeneralCmp(ILCommand):
    ...
    def _fix_both_literal_or_mem(self, arg1_spot, arg2_spot, regs, get_reg, asm_code):
    ...
    def _fix_either_literal64(self, arg1_spot, arg2_spot, regs, get_reg, asm_code):
    ...
    def make_asm(self, spotmap, home_spots, get_reg, asm_code):
        ...
        arg1_spot, arg2_spot = self._fix_both_literal_or_mem(spotmap[self.arg1], spotmap[self.arg2],
                                                             regs, get_reg, asm_code)
        arg1_spot, arg2_spot = self._fix_either_literal64(arg1_spot, arg2_spot, regs, get_reg, asm_code)
...
class NotEqualCmp(_GeneralCmp):
    ...
    IL value output must have int type. arg1, arg2 must all have the same type. No type conversion or promotion is done.
    """
...
class EqualCmp(_GeneralCmp):
    ...
    the same type. No type conversion or promotion is done here.
    """
