...
class LoadArg(ILCommand):
    """Loads a function argument value into an IL value.
        ...
        output - IL value to load the function argument value into, and arg_num is the index of the argument to load.
        For example, at the start of the body of the following function:
